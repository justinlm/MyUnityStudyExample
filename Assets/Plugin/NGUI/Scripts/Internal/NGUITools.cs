...
static public class NGUITools
{
	...
	/// <summary>
	/// New WWW call can fail if the crossdomain policy doesn't check out. 
    /// Exceptions suck. It's much more elegant to check for null instead.
	/// </summary>
    ...
    static public T FindInParents<T>(Transform trans,bool includeSelf=true) where T : Component
    {
