...
static public class NGUIMath
{
	...
	/// <summary>
	/// Calculate the combined bounds of all widgets 
    /// attached to the specified game object or its children (in relative-to-object space).
	/// </summary>
	...
	/// <summary>
	/// Calculate the combined bounds of all widgets attached to
    /// the specified game object or its children (in relative-to-object space).
	/// </summary>
