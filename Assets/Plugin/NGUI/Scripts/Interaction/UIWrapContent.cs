...
public class UIWrapContent : MonoBehaviour
{
	...
	/// <summary>
	/// Whether the content will be automatically culled. Enabling this will improve 
    /// performance in scroll views that contain a lot of items.
	/// </summary>
    ...
    public BetterList<Transform> mChildren 
        = new BetterList<Transform>();
